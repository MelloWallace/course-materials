...
func main() {
	...
	//////Downloaded 10_million_password_list_top_100000.txt
	...
	//Main will detect parameter argumetns and if there is a name then the hardcoded file name will be replaced
